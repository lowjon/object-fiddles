...
//being your favorite brand.
  ...
  //Code here
  favoriteThings.car = "Mazda b2200";
...
//to be specific to you (name: 'your name', username: 'your username'), rather than my information.
  ...
  //Code Here
  user1.name = 'Jon Low';
  user1.username = "lowjon";
  user1.pwHash = 'yoyoyoyo';
...
Object.keys(card).forEach(function (key){person[key]=card[key];});
return person;
}
